import {
  defaultMenuTypeBackApp,
  defaultMenuTypeClientApp,
  subHiddenBreakpoint,
...
const INIT_STATE = {
  containerClassnames: defaultMenuTypeBackApp,
  containerClassnamesClientApp: defaultMenuTypeClientApp,
  subHiddenBreakpoint,
  menuHiddenBreakpoint,
  menuClickCount: 0,
  selectedMenuHasSubItems: defaultMenuTypeBackApp === 'menu-default', // if you use menu-sub-hidden as default menu type, set value of this variable to false
};
