...
class Encuesta:
    def __init__(self,grupo,integrante,genero,edad,nivelEducacional,region, comuna, estadoCivil, jefeHogar, personasDependen, viviendoLugar,ingresoFamilia, anosSiendoIntegranteSindicato, integranteFundador, reelevanciaSindicato, puedeExternoPostular,puedeSindicatoExpulsar,sindicatoHaIntegradoNuevosMiembros, sindicatoHaExpulsadoNuevosMiembros):
        self.grupo = grupo
        ...
        self.viviendoLugar = viviendoLugar
        self.ingresoFamilia = ingresoFamilia
        self.anosSiendoIntegranteSindicato = anosSiendoIntegranteSindicato

        self.integranteFundador = integranteFundador
        self.reelevanciaSindicato = reelevanciaSindicato
        self.puedeExternoPostular = puedeExternoPostular
        self.puedeSindicatoExpulsar = puedeSindicatoExpulsar
...
class Entorno:
    ...
    def exportarDatos(self):
        f = open("appDB_t2_16_00_g2", "rb")
        nombreArchivoExportar = "exportacion_t2_16_00_grupo2.csv"
        sesionNombre = "t2_16_00"
        grupo = "2"

        actividades = self.actividades

        """arrayToAsig = ['t1_12_35', '1',numero, str(act.prueba), asigAux.client_id, letraExport,asigAux.ronda ,
             asigAux.club, asigAux.fichasClub, asigAux.fichasActividadPrivada, asigAux.cantidadJugadoresAzul, asigAux.cantidadJugadoresAmarillo,
        ...
        "VE_1","VE_2","VE_3","VE_4","VE_5","VE_6","VE_7","VE_8","VI_1","VI_2","VI_3","VI_4","VI_5","VI_6","VI_7","VI_8"]
        asigArray = []
        ...
        for act in actividades:
            ...
            for asigAux in asignaciones:
                ...
                #vota_1, vota_2, vota_3, vota_4, vota_5, vota_6, vota_7,vota_8
                # NO PUEDE VOTAR POR EL MISMO
                arrayVE = ["0","0","0","0","0","0","0","0"]
                arrayVE[client_id - 1] = "."

                ## IMPRIMIREMOS LOS VOTOS INCLUIR Y EXCLUIR
                if votoExcluirAux is not None:
                    print("----VOTO EXCLUIR--------")
                    print("ACTIVIDAD : " +str(numero))
                    print("Cliente : " + str(client_id))
                    print("vota por : " + str(votoExcluirAux.votaPor))
                    print("ronda :" + str(votoExcluirAux.ronda))
                ...
                if votoIncluirAux is not None:
                    ...
                    print("ACTIVIDAD : " +str(numero))
                    print("Cliente : " + str(client_id))
                    print("vota por : " + str(votoIncluirAux.votaPor))
                    print("ronda :" + str(votoIncluirAux.ronda))
                ...
                arrayToAsig = [sesionNombre, grupo,numero, str(act.prueba), asigAux.client_id, letra,asigAux.ronda ,
        ...
        nombreArchivo = nombreArchivoExportar
    ...
    def addEncuesta(self, data):
        ...
        grupo = self.grupo
        genero = data['selectGenero']
        edad = data['selectEdad']
        nivelEducacional = data['selectNivelEducacional']
        region = data['selectRegion']
        comuna = data['selectComuna']
        estadoCivil = data['selectEstadoCivil']
        jefeHogar = data['selectJefeHogar']
        personasDependen = data['selectPersonasDependen']
        viviendoLugar = data['selectViviendoLugar']
        ingresoFamilia = data['ingresoFamilia']
        anosSiendoIntegranteSindicato = data['anosSiendoIntegranteSindicato']
        integranteFundador = data['selectIntegranteFundador']
        reelevanciaSindicato = data['reelevanciaSindicato']
        puedeExternoPostular = data['selectPuedeExternoPostular']
        puedeSindicatoExpulsar = data['selectPuedeSindicatoExpulsar']
        sindicatoHaIntegradoNuevosMiembros = data['selectSindicatoHaIntegradoNuevosMiembros']
        sindicatoHaExpulsadoNuevosMiembros = data['selectSindicatoHaExpulsadoNuevosMiembros']

        encuesta = Encuesta(grupo,integrante,genero,edad,nivelEducacional,region, comuna, estadoCivil, jefeHogar, personasDependen, viviendoLugar,ingresoFamilia, anosSiendoIntegranteSindicato, integranteFundador, reelevanciaSindicato, puedeExternoPostular,puedeSindicatoExpulsar,sindicatoHaIntegradoNuevosMiembros, sindicatoHaExpulsadoNuevosMiembros)
